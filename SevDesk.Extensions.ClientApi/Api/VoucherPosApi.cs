		...
		string voucherObjectName = null)
	{
		...
		if (voucherId != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "voucher[id]", voucherId)); // query parameter
		if (voucherObjectName != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "voucher[objectName]",
					voucherObjectName)); // query parameter
		...
		{
			var exception = ExceptionFactory("GetVoucherPositions", localVarResponse);
			if (exception != null) throw exception;
		}

		return new ApiResponse<GetVoucherPositionsResponse>(localVarStatusCode,
			localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
			(GetVoucherPositionsResponse)Configuration.ApiClient.Deserialize(localVarResponse,
