...
public class ContactApi : IContactApi
{
		...
		string customerNumber = null)
	{
		...
		if (customerNumber != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "customerNumber",
					customerNumber)); // query parameter
		...
		{
			var exception = ExceptionFactory("ContactCustomerNumberAvailabilityCheck", localVarResponse);
    ...
    public ApiResponse<GetContactResponse> CreateContactWithHttpInfo(ModelContact body = null)
	{
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("CreateContact", localVarResponse);
			if (exception != null) throw exception;
		}

		return new ApiResponse<GetContactResponse>(localVarStatusCode,
			localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
    ...
    public ApiResponse<InlineResponse2003> DeleteContactWithHttpInfo(int? contactId)
	{
		...
		if (contactId == null)
			throw new ApiException(400,
				"Missing required parameter 'contactId' when calling ContactApi->DeleteContact");
		...
		if (contactId != null)
			localVarPathParams.Add("contactId", Configuration.ApiClient.ParameterToString(contactId)); // path parameter
		// authentication (api_key) required
		if (!string.IsNullOrEmpty(Configuration.GetApiKeyWithPrefix("Authorization")))
			localVarHeaderParams["Authorization"] = Configuration.GetApiKeyWithPrefix("Authorization");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("DeleteContact", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<GetContactResponse> GetContactByIdWithHttpInfo(int? contactId)
	{
		...
		if (contactId == null)
			throw new ApiException(400,
				"Missing required parameter 'contactId' when calling ContactApi->GetContactById");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetContactById", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<InlineResponse20018> GetContactTabsItemCountByIdWithHttpInfo(int? contactId)
	{
		...
		if (contactId == null)
			throw new ApiException(400,
				"Missing required parameter 'contactId' when calling ContactApi->GetContactTabsItemCountById");

		var localVarPath = "/Contact/{contactId}/getTabsItemCount";
		var localVarPathParams = new Dictionary<string, string>();
		var localVarQueryParams = new List<KeyValuePair<string, string>>();
		var localVarHeaderParams = new Dictionary<string, string>(Configuration.DefaultHeader);
		var localVarFormParams = new Dictionary<string, string>();
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetContactTabsItemCountById", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<GetContactResponse> GetContactsWithHttpInfo(string depth = null, string customerNumber = null)
	{
		...
		if (depth != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "depth", depth)); // query parameter
		if (customerNumber != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "customerNumber",
					customerNumber)); // query parameter
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetContacts", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<InlineResponse20035> GetNextCustomerNumberWithHttpInfo()
	{
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetNextCustomerNumber", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<GetContactResponse> UpdateContactWithHttpInfo(int? contactId, ModelContactUpdate body = null)
	{
		...
		if (contactId == null)
			throw new ApiException(400,
				"Missing required parameter 'contactId' when calling ContactApi->UpdateContact");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("UpdateContact", localVarResponse);
			if (exception != null) throw exception;
		}
