...
public class ReportApi : IReportApi
{
	...
	public ApiResponse<object> ReportContactWithHttpInfo(SevQuery7 sevQuery, bool? download = null)
	{
		...
		if (sevQuery == null)
			throw new ApiException(400, "Missing required parameter 'sevQuery' when calling ReportApi->ReportContact");

		var localVarPath = "/Report/contactlist";
		...
		{
			var exception = ExceptionFactory("ReportContact", localVarResponse);
	...
	public ApiResponse<object> ReportInvoiceWithHttpInfo(SevQuery2 sevQuery, bool? download = null)
	{
		// verify the required parameter 'sevQuery' is set
		if (sevQuery == null)
			throw new ApiException(400, "Missing required parameter 'sevQuery' when calling ReportApi->ReportInvoice");

		var localVarPath = "/Report/invoicelist";
		var localVarPathParams = new Dictionary<string, string>();
		var localVarQueryParams = new List<KeyValuePair<string, string>>();
		var localVarHeaderParams = new Dictionary<string, string>(Configuration.DefaultHeader);
		var localVarFormParams = new Dictionary<string, string>();
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("ReportInvoice", localVarResponse);
			if (exception != null) throw exception;
		}
	...
	public ApiResponse<object> ReportOrderWithHttpInfo(SevQuery3 sevQuery, bool? download = null)
	{
		// verify the required parameter 'sevQuery' is set
		if (sevQuery == null)
			throw new ApiException(400, "Missing required parameter 'sevQuery' when calling ReportApi->ReportOrder");

		var localVarPath = "/Report/orderlist";
		var localVarPathParams = new Dictionary<string, string>();
		var localVarQueryParams = new List<KeyValuePair<string, string>>();
		var localVarHeaderParams = new Dictionary<string, string>(Configuration.DefaultHeader);
		var localVarFormParams = new Dictionary<string, string>();
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("ReportOrder", localVarResponse);
			if (exception != null) throw exception;
		}
	...
	public ApiResponse<object> ReportVoucherWithHttpInfo(SevQuery5 sevQuery, bool? download = null)
	{
		// verify the required parameter 'sevQuery' is set
		if (sevQuery == null)
			throw new ApiException(400, "Missing required parameter 'sevQuery' when calling ReportApi->ReportVoucher");

		var localVarPath = "/Report/voucherlist";
		var localVarPathParams = new Dictionary<string, string>();
		var localVarQueryParams = new List<KeyValuePair<string, string>>();
		var localVarHeaderParams = new Dictionary<string, string>(Configuration.DefaultHeader);
		var localVarFormParams = new Dictionary<string, string>();
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("ReportVoucher", localVarResponse);
			if (exception != null) throw exception;
		}
