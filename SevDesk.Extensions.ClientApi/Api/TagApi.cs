...
public class TagApi : ITagApi
{
    ...
    public ApiResponse<InlineResponse20030> CreateTagWithHttpInfo(FactoryCreateBody body = null)
	{
		...
		{
			var exception = ExceptionFactory("CreateTag", localVarResponse);
    ...
    public ApiResponse<InlineResponse2003> DeleteTagWithHttpInfo(int? tagId)
	{
		...
		if (tagId != null)
			localVarPathParams.Add("tagId", Configuration.ApiClient.ParameterToString(tagId)); // path parameter
		// authentication (api_key) required
		if (!string.IsNullOrEmpty(Configuration.GetApiKeyWithPrefix("Authorization")))
			localVarHeaderParams["Authorization"] = Configuration.GetApiKeyWithPrefix("Authorization");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("DeleteTag", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<InlineResponse20019> GetTagByIdWithHttpInfo(int? tagId)
	{
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetTagById", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<InlineResponse20030> GetTagRelationsWithHttpInfo()
	{
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetTagRelations", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<InlineResponse20019> UpdateTagWithHttpInfo(int? tagId, TagTagIdBody body = null)
	{
		// verify the required parameter 'tagId' is set
		if (tagId == null)
			throw new ApiException(400, "Missing required parameter 'tagId' when calling TagApi->UpdateTag");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("UpdateTag", localVarResponse);
			if (exception != null) throw exception;
		}
