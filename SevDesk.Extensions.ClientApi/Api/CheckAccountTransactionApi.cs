...
public class CheckAccountTransactionApi : ICheckAccountTransactionApi
{
    ...
    public ApiResponse<InlineResponse2004> CreateTransactionWithHttpInfo(ModelCheckAccountTransaction body = null)
	{
		...
		{
			var exception = ExceptionFactory("CreateTransaction", localVarResponse);
    ...
    public ApiResponse<InlineResponse2003> DeleteCheckAccountTransactionWithHttpInfo(int? checkAccountTransactionId)
	{
		...
		if (checkAccountTransactionId == null)
			throw new ApiException(400,
				"Missing required parameter 'checkAccountTransactionId' when calling CheckAccountTransactionApi->DeleteCheckAccountTransaction");

		var localVarPath = "/CheckAccountTransaction/{checkAccountTransactionId}";
		var localVarPathParams = new Dictionary<string, string>();
		var localVarQueryParams = new List<KeyValuePair<string, string>>();
		var localVarHeaderParams = new Dictionary<string, string>(Configuration.DefaultHeader);
		var localVarFormParams = new Dictionary<string, string>();
		...
		if (checkAccountTransactionId != null)
			localVarPathParams.Add("checkAccountTransactionId",
				Configuration.ApiClient.ParameterToString(checkAccountTransactionId)); // path parameter
		// authentication (api_key) required
		if (!string.IsNullOrEmpty(Configuration.GetApiKeyWithPrefix("Authorization")))
			localVarHeaderParams["Authorization"] = Configuration.GetApiKeyWithPrefix("Authorization");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("DeleteCheckAccountTransaction", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<InlineResponse2004> GetCheckAccountTransactionByIdWithHttpInfo(int? checkAccountTransactionId)
	{
		...
		if (checkAccountTransactionId == null)
			throw new ApiException(400,
				"Missing required parameter 'checkAccountTransactionId' when calling CheckAccountTransactionApi->GetCheckAccountTransactionById");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetCheckAccountTransactionById", localVarResponse);
			if (exception != null) throw exception;
		}
	...
	{
		var localVarResponse = GetTransactionsWithHttpInfo(checkAccountId, checkAccountObjectName, isBooked,
			paymtPurpose, startDate, endDate, payeePayerName, onlyCredit, onlyDebit);
		return localVarResponse.Data;
	}
		...
		bool? onlyDebit = null)
	{
		...
		if (checkAccountId != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "checkAccount[id]",
					checkAccountId)); // query parameter
		if (checkAccountObjectName != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "checkAccount[objectName]",
					checkAccountObjectName)); // query parameter
		if (isBooked != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "isBooked", isBooked)); // query parameter
		if (paymtPurpose != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "paymtPurpose", paymtPurpose)); // query parameter
		if (startDate != null)
			localVarQueryParams.AddRange(
		...
		if (payeePayerName != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "payeePayerName",
					payeePayerName)); // query parameter
		if (onlyCredit != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "onlyCredit", onlyCredit)); // query parameter
		if (onlyDebit != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "onlyDebit", onlyDebit)); // query parameter
		// authentication (api_key) required
		if (!string.IsNullOrEmpty(Configuration.GetApiKeyWithPrefix("Authorization")))
			localVarHeaderParams["Authorization"] = Configuration.GetApiKeyWithPrefix("Authorization");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetTransactions", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public async Task<InlineResponse2004> GetTransactionsAsync(int? checkAccountId = null,
		...
		bool? onlyDebit = null)
	{
		var localVarResponse = await GetTransactionsAsyncWithHttpInfo(checkAccountId, checkAccountObjectName, isBooked,
			paymtPurpose, startDate, endDate, payeePayerName, onlyCredit, onlyDebit);
		return localVarResponse.Data;
	}
		...
		ModelCheckAccountTransactionUpdate body = null)
	{
		...
		if (checkAccountTransactionId == null)
			throw new ApiException(400,
				"Missing required parameter 'checkAccountTransactionId' when calling CheckAccountTransactionApi->UpdateCheckAccountTransaction");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("UpdateCheckAccountTransaction", localVarResponse);
			if (exception != null) throw exception;
		}
