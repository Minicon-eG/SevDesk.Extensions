...
/// </summary>
public class CreditNotePosApi : ICreditNotePosApi
{
		...
		string creditNoteObjectName = null)
	{
		...
		if (creditNoteId != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "creditNote[id]",
					creditNoteId)); // query parameter
		if (creditNoteObjectName != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "creditNote[objectName]",
					creditNoteObjectName)); // query parameter
		...
		{
			var exception = ExceptionFactory("GetcreditNotePositions", localVarResponse);
