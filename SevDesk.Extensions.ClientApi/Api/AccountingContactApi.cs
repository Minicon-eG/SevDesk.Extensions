...
public class AccountingContactApi : IAccountingContactApi
{
		...
		ModelAccountingContact body = null)
	{
		...
		{
			var exception = ExceptionFactory("CreateAccountingContact", localVarResponse);
			if (exception != null) throw exception;
		}

		return new ApiResponse<GetAccountContactResponse>(localVarStatusCode,
			localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
			(GetAccountContactResponse)Configuration.ApiClient.Deserialize(localVarResponse,
    ...
    public ApiResponse<InlineResponse2003> DeleteAccountingContactWithHttpInfo(int? accountingContactId)
	{
		...
		if (accountingContactId == null)
			throw new ApiException(400,
				"Missing required parameter 'accountingContactId' when calling AccountingContactApi->DeleteAccountingContact");

		var localVarPath = "/AccountingContact/{accountingContactId}";
		var localVarPathParams = new Dictionary<string, string>();
		var localVarQueryParams = new List<KeyValuePair<string, string>>();
		var localVarHeaderParams = new Dictionary<string, string>(Configuration.DefaultHeader);
		var localVarFormParams = new Dictionary<string, string>();
		...
		if (accountingContactId != null)
			localVarPathParams.Add("accountingContactId",
				Configuration.ApiClient.ParameterToString(accountingContactId)); // path parameter
		// authentication (api_key) required
		if (!string.IsNullOrEmpty(Configuration.GetApiKeyWithPrefix("Authorization")))
			localVarHeaderParams["Authorization"] = Configuration.GetApiKeyWithPrefix("Authorization");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("DeleteAccountingContact", localVarResponse);
			if (exception != null) throw exception;
		}
		...
		string contactObjectName = null)
	{
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetAccountingContact", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<GetAccountContactResponse> GetAccountingContactByIdWithHttpInfo(int? accountingContactId)
	{
		...
		if (accountingContactId == null)
			throw new ApiException(400,
				"Missing required parameter 'accountingContactId' when calling AccountingContactApi->GetAccountingContactById");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetAccountingContactById", localVarResponse);
			if (exception != null) throw exception;
		}
		...
		ModelAccountingContactUpdate body = null)
	{
		...
		if (accountingContactId == null)
			throw new ApiException(400,
				"Missing required parameter 'accountingContactId' when calling AccountingContactApi->UpdateAccountingContact");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("UpdateAccountingContact", localVarResponse);
			if (exception != null) throw exception;
		}
