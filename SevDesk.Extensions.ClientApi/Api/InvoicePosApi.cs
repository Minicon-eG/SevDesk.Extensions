...
public class InvoicePosApi : IInvoicePosApi
{
		...
		string invoiceObjectName = null, decimal? partId = null, string partObjectName = null)
	{
		...
		if (partId != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "part[id]", partId)); // query parameter
		if (partObjectName != null)
			localVarQueryParams.AddRange(
				Configuration.ApiClient.ParameterToKeyValuePairs("", "part[objectName]",
					partObjectName)); // query parameter
		...
		{
			var exception = ExceptionFactory("GetInvoicePos", localVarResponse);
		...
		string invoiceObjectName = null, decimal? partId = null, string partObjectName = null)
	{
		var localVarResponse =
			await GetInvoicePosAsyncWithHttpInfo(id, invoiceId, invoiceObjectName, partId, partObjectName);
		return localVarResponse.Data;
	}
