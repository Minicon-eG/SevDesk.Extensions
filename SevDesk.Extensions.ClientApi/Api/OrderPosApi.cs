...
public class OrderPosApi : IOrderPosApi
{
    ...
    public ApiResponse<InlineResponse2003> DeleteOrderPosWithHttpInfo(int? orderPosId)
	{
		...
		if (orderPosId == null)
			throw new ApiException(400,
				"Missing required parameter 'orderPosId' when calling OrderPosApi->DeleteOrderPos");

		var localVarPath = "/OrderPos/{orderPosId}";
		...
		if (orderPosId != null)
			localVarPathParams.Add("orderPosId",
				Configuration.ApiClient.ParameterToString(orderPosId)); // path parameter
		...
		{
			var exception = ExceptionFactory("DeleteOrderPos", localVarResponse);
    ...
    public ApiResponse<InlineResponse2007> GetOrderPositionByIdWithHttpInfo(int? orderPosId)
	{
		...
		if (orderPosId == null)
			throw new ApiException(400,
				"Missing required parameter 'orderPosId' when calling OrderPosApi->GetOrderPositionById");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetOrderPositionById", localVarResponse);
			if (exception != null) throw exception;
		}
		...
		string orderObjectName = null)
	{
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetOrderPositions", localVarResponse);
			if (exception != null) throw exception;
		}
		...
		ModelOrderPosUpdate body = null)
	{
		...
		if (orderPosId == null)
			throw new ApiException(400,
				"Missing required parameter 'orderPosId' when calling OrderPosApi->UpdateOrderPosition");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("UpdateOrderPosition", localVarResponse);
			if (exception != null) throw exception;
		}
