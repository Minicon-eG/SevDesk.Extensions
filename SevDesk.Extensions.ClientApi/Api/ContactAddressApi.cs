...
public class ContactAddressApi : IContactAddressApi
{
    ...
    public ApiResponse<InlineResponse20013> ContactAddressIdWithHttpInfo(int? contactAddressId)
	{
		...
		if (contactAddressId == null)
			throw new ApiException(400,
				"Missing required parameter 'contactAddressId' when calling ContactAddressApi->ContactAddressId");

		var localVarPath = "/ContactAddress/{contactAddressId}";
		...
		if (contactAddressId != null)
			localVarPathParams.Add("contactAddressId",
				Configuration.ApiClient.ParameterToString(contactAddressId)); // path parameter
		...
		{
			var exception = ExceptionFactory("ContactAddressId", localVarResponse);
    ...
    public ApiResponse<InlineResponse20013> CreateContactAddressWithHttpInfo(ModelContactAddress body = null)
	{
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("CreateContactAddress", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<InlineResponse2003> DeleteContactAddressWithHttpInfo(int? contactAddressId)
	{
		...
		if (contactAddressId == null)
			throw new ApiException(400,
				"Missing required parameter 'contactAddressId' when calling ContactAddressApi->DeleteContactAddress");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("DeleteContactAddress", localVarResponse);
			if (exception != null) throw exception;
		}
    ...
    public ApiResponse<InlineResponse20013> GetContactAddressesWithHttpInfo()
	{
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("GetContactAddresses", localVarResponse);
			if (exception != null) throw exception;
		}
		...
		ModelContactAddressUpdate body = null)
	{
		...
		if (contactAddressId == null)
			throw new ApiException(400,
				"Missing required parameter 'contactAddressId' when calling ContactAddressApi->UpdateContactAddress");
		...
		if (ExceptionFactory != null)
		{
			var exception = ExceptionFactory("UpdateContactAddress", localVarResponse);
			if (exception != null) throw exception;
		}
